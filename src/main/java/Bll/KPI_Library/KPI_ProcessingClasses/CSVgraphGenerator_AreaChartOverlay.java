...
public class CSVgraphGenerator_AreaChartOverlay implements IViewGenerator {
    private AreaChart<Number, Number> graphType1;
    private NumberAxis xAxis;
    private NumberAxis yAxis;

    public CSVgraphGenerator_AreaChartOverlay(){}
    ...
    public void getSeriesFromCSV(String source) {
        ...
        graphType1.getData().addAll(dataSeries1, dataSeries2);
